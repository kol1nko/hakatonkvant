...
# Метод: Используется классический подход к оптимизации, основанный на модели Марковица. Для решения задачи используется квадратичное программирование, которое хорошо подходит для задач оптимизации портфеля, где необходимо найти оптимальное распределение весов акций с учетом доходности и риска.
